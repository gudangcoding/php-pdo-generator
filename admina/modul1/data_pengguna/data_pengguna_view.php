...
<form method="get" class="form-horizontal" action="">
                      <div class="form-group">
                        <label for="Menu" class="control-label col-lg-2">Level Pengguna</label>
                        <div class="col-lg-4">
...
?>       
<h3 class="btn btn-primary btn-block">Checklist Untuk memberikan Hak Akses</h3>
...
function read_act(id,cb) {
  ...
  $.ajax({
        ...
        type: "post",
        url: "<?=base_admin();?>modul/data_pengguna/data_pengguna_action.php?act=change_read",
...
function insert_act(id,cb) {
  ...
  $.ajax({
        ...
        type: "post",
        url: "<?=base_admin();?>modul/data_pengguna/data_pengguna_action.php?act=change_insert",
        data: "role_id="+id+"&data_act="+check_act,
     //  enctype:  'multipart/form-data'
      success: function(data){
...
function update_act(id,cb) {
  ...
  $.ajax({
        ...
        type: "post",
        url: "<?=base_admin();?>modul/data_pengguna/data_pengguna_action.php?act=change_update",
        data: "role_id="+id+"&data_act="+check_act,
     //  enctype:  'multipart/form-data'
      success: function(data){
...
function delete_act(id,cb) {
  ...
  $.ajax({
        ...
        type: "post",
        url: "<?=base_admin();?>modul/data_pengguna/data_pengguna_action.php?act=change_delete",
        data: "role_id="+id+"&data_act="+check_act,
     //  enctype:  'multipart/form-data'
      success: function(data){
