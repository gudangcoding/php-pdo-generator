                      ...
                      <div class="tab-content">
                          <div role="tabpanel" class="tab-pane active" id="ftl">
                            <div class="table-responsive" style="margin-top: 20px;">
                                <a href="<?=base_admin()?>index.php/daftar-muatan/tambah-ftl" class="btn btn-primary"><i class="fa fa-plus"></i> Muatan</a><hr>
                                <table id="daftarmuatan" class="table table-hover">
                                    <thead>
                                        <tr>
