                        ...
                        <div class="tab-content" style="margin-top: 50px;">
                            <div role="tabpanel" class="tab-pane active" id="umum">
                                <form>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="nm_perusahaan" id="nm_perusahaan"
                                                value="<?=$data_edit->nm_perusahaan?>" class="form-control" required>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <textarea name="almt_kantor" id="almt_kantor" class="form-control" rows="3"
                                                required><?=$data_edit->almt_kantor?></textarea>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="email" name="email" id="email" value="<?=$data_edit->email?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="web" id="web" value="www.domain.com"
                                                class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="telp" id="telp" value="021-123456"
                                                class="form-control" required>
                                        </div>
                                    ...
                                    <br>
                                    <a href="<?=base_admin() ?>index.php/pelanggan"
                                        class="btn btn-warning pull-left">Kembali</a>
                                    <button type="button" class="btn btn-primary pull-right" id="btnumum">Simpan &
                                        Lanjut</button>
                                </form>
                            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" name="nmlengkap" id="nm_lengkap"
                                                        value="Nama Lengkap" class="form-control col-xs-3" required="">
                                                </td>

                                                <td>
                                                    <input type="text" name="posisi" id="posisi" value="Kepala Gudang"
                                                        class="form-control" required="">
                                                </td>

                                                <td>
                                                    <input type="text" name="nosel" id="no_hp" value="0812123456"
                                                        class="form-control" required="">
                                                </td>
                            ...
                            <div role="tabpanel" class="tab-pane" id="legal">
                                <form>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <textarea name="almt_penagihan" id="almt_penagihan" class="form-control"
                                                rows="3" value="Input Alamat" required="required"></textarea>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="text" name="cb_bank" id="cb_bank" class="form-control"
                                                value="Input Cabang Bank" required="">
                                        </div>
                                    </div>
                                    <br>
                                    <button type="button" class="btn btn-warning pull-left"
                                        id="btnlegalback">Kembali</button>
                            ...
                            <div role="tabpanel" class="tab-pane" id="tarif">
                                <div class="table-responsive">
                                    ...
                                    <br>
                                    <button type="button" class="btn btn-warning pull-left"
                                        id="btnsimpanallback">Kembali</button>
...
//     scntDiv.append(
//         '<tr><td><input type="text" name="nmlengkap" id="nmlengkap" value="Nama Lengkap" class="form-control col-xs-3" required=""></td><td><input type="text" name="posisi" id="posisi" value="Kepala Gudang" class="form-control" required=""></td><td><input type="text" name="nosel" id="nosel" value="0812123456" class="form-control" required=""></td><td><button type="button" id="aksi" class="btn btn-warning"><i class="fa fa-pencil"></i></button></td><td><button type="button" id="remScnt" class="btn btn-danger"><span class="glyphicon glyphicon-trash aria-hidden="true"></span></button></td></tr>'
//     );
//     i++;
//     return false;
// });
...
//select otomatis saat edit sesuai id di tabel database
function selectedLegal(){
    var data = {
        id: <?=json_encode($data_join)?>,
        text: '<?=$data_join->Nama_Legal?>'
    };
