...
<div class="row">
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/biaya/biaya_action.php?act=in">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="Layanan_Berlangganan" placeholder="Layanan Berlangganan" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
