        ...
        <div class="box box-solid box-primary">
               ...
               <?php foreach ($db->fetch_all("Legal") as $isi) {
                  ...
                  if ($data_edit->legal==$isi->Inisial) {
                    echo "<option value='$isi->Inisial' selected>$isi->Nama_Legal</option>";
                  } else {
...
<div class='row'>
                      <div class='form-group col-xs-6'>
                        <label for=Inisial Departement>Inisial Departement</label>
                          <input type="text" name="form" value="<?=$data_edit->form;?>" class="form-control" required> 
                      </div>
                    </div><!-- /.form-group -->
<div class='row'>
                      <div class='form-group col-xs-6'>
                        <label for=Awalan Kwitansi>Awalan Kwitansi</label>
                          <input type="text" name="prefix" value="<?=$data_edit->prefix;?>" class="form-control" required> 
                      </div>
                    </div><!-- /.form-group -->
<div class='row'>
                      <div class='form-group col-xs-6'>
                        <label for=Awal Nomor>Awal Nomor</label>
                          <input type="text" name="penomoran" value="<?=$data_edit->penomoran;?>" class="form-control" > 
                      </div>
                    </div><!-- /.form-group -->
<div class='row'>
                      <div class='form-group col-xs-6'>
                        <label for=user_id>user_id</label>
                          <input type="text" name="user_id" value="<?=$data_edit->user_id;?>" class="form-control" > 
                      </div>
                    </div><!-- /.form-group -->
