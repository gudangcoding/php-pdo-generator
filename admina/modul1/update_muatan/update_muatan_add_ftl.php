...
<br>
	<div align="left">
              ...
              <div role="tabpane1" class="tab-pane" id="armada">
              	<div class="table-responsive">
              		<h3 class="btn btn-primary btn-block" style="text-align: left;">Armada</h3>
              		<table class="table dynatable Umum">
    		<thead>
    			<tr>
	...
	<div align="left">
              ...
              <div role="tabpane1" class="tab-pane" id="biaya">
              	<div class="table-responsive">
              		<h3 class="btn btn-primary btn-block" style="text-align: left;">Biaya</h3>
              		<table class="table dynatable Umum">
    		<thead>
    			<tr>
...
<br>
	<div align="left">
              ...
              <div role="tabpane1" class="tab-pane" id="status">
              	<div class="table-responsive">
              		<h3 class="btn btn-primary btn-block" style="text-align: left;">Status</h3>
              		<table class="table dynatable Umum">
    		<thead>
    			<tr>
