                ...
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li class="active">Detail Informasi Umum</li>
                    </ol>
                </section>
    ...
    <div class="col-lg-12">
        <div class="box box-solid box-primary">
                                   <div class="box-header">
                                    <h3 class="box-title">Detail Informasi Umum</h3>
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->Nama_Legal;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Alamat Legal" class="control-label col-lg-2">Alamat Legal</label>
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->Alamat_Legal;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->Alamat_Email;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                  ...
                  if ($data_edit->Posisi==$isi->id) {
                    ...
                    echo "<input disabled class='form-control' type='text' value='$isi->Nama_jabatan'>";
                  }
               } ?>
