                  ...
                  <div class="box-body">
                     <form id="update" method="post" class="form-horizontal" action="<?=base_admin();?>modul/tempo_pembayaran/tempo_pembayaran_action.php?act=up">
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="Nama_Tempo_Pembayaran" value="<?=$data_edit->Nama_Tempo_Pembayaran;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Jumlah Hari" class="control-label col-lg-2">Jumlah Hari</label>
                        <div class="col-lg-10">
                          <input type="text" name="Jumlah_Hari" value="<?=$data_edit->Jumlah_Hari;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
