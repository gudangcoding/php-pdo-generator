...
<section class="content-header">
    <h1>
        ...
        <li><a href="<?=base_index();?>suplier">Vendor</a></li>
...
<div class="tab-pane active" id="1a">
  <a class="btn btn-primary" href="<?=base_admin();?>index.php/vendor/tambah"><span class="glyphicon glyphicon-plus"
     aria-hidden="true"></span> Tambah</a><hr>
  <table id="tbvendor" class="table table-responsive table-condensed">
  <thead>
    <tr class="success">
        <th>No</th>
...
$(document).ready(function() {
        ...
        var table = $("#tbvendor").dataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: "<?php echo base_admin()?>modul/vendor/vendor_data.php"
            }
...
$("#simpan").click(function(event) {
            ...
            if (id == '') {
                $.ajax({
                    url: '<?php echo base_admin()?>modul/vendor/vendor_action.php?act=in',
                    type: 'POST',
                    data: {
                        id: $("#id").val(),
    ...
    function edit(id) {
        ...
        $.ajax({
            url: '<?php echo base_admin()?>modul/vendor/vendor_edit.php',
            type: 'POST',
            dataType: 'json',
            data: {
                id: id
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?php echo base_admin()?>modul/vendor/vendor_action.php?act=hapus',
                    type: 'POST',
                    data: {
                        id: id
                    },
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
        	<div class="row">
        		...
        		<div class="panel panel-primary">
        			<div class="panel-heading">
        				<h3 class="panel-title" style="text-align: center;">Informasi Umum</h3>
        			</div>
        	...
        	<div class="panel panel-primary">
        		<div class="panel-heading">
        			<h3 class="panel-title" style="text-align: center;">Informasi Kontak</h3>
        		</div>
        	</div>
        	<div class="row">
        		<div class="form-group col-xs-6">
        	...
        	<div class="panel panel-primary">
        		<div class="panel-heading">
        			<h3 class="panel-title" style="text-align: center;">Informasi Finansial</h3>
        		</div>
