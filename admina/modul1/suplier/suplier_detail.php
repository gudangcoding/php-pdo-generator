...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=tgl_indo($data_edit->tmp_bayar);?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" disabled="" value="<?=$data_edit->satuan_pajak;?>" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
