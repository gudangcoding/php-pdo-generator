...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="no_truk" value="<?=$data_edit->no_truk;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" data-rule-number="true" name="pjg_bak" value="<?=$data_edit->pjg_bak;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Tinggi Bak" class="control-label col-lg-2">Tinggi Bak</label>
                        <div class="col-lg-10">
                          <input type="text" data-rule-number="true" name="tinggi_bak" value="<?=$data_edit->tinggi_bak;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Lebar Bak" class="control-label col-lg-2">Lebar Bak</label>
                        <div class="col-lg-10">
                          <input type="text" data-rule-number="true" name="lbr_bak" value="<?=$data_edit->lbr_bak;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <?php if ($data_edit->sts_pajak=="Y") {
      ?>
      <input name="sts_pajak" class="make-switch" type="checkbox" checked>
      <?php
    } else {
      ?>
      <input name="sts_pajak" class="make-switch" type="checkbox">
      <?php
    }?>
                        </div>
                      </div><!-- /.form-group -->
