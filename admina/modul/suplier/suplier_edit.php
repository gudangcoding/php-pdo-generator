...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="notlp" value="<?=$data_edit->notlp;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="nohp" value="<?=$data_edit->nohp;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="nm_penagihan" value="<?=$data_edit->nm_penagihan;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Alamat Penagihan" class="control-label col-lg-2">Alamat Penagihan</label>
                        <div class="col-lg-10">
                          <textarea id="editbox" name="almt_penagihan" class="editbox"required><?=$data_edit->almt_penagihan;?> </textarea>
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="nama Bank" class="control-label col-lg-2">nama Bank</label>
                        <div class="col-lg-10">
                          <input type="text" name="nm_bank" value="<?=$data_edit->nm_bank;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Cabang Bank" class="control-label col-lg-2">Cabang Bank</label>
                        <div class="col-lg-10">
                          <input type="text" name="cb_bank" value="<?=$data_edit->cb_bank;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Kode Bank" class="control-label col-lg-2">Kode Bank</label>
                        <div class="col-lg-10">
                          <input type="text" data-rule-number="true" name="kode_bank" value="<?=$data_edit->kode_bank;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Nomor Rek" class="control-label col-lg-2">Nomor Rek</label>
                        <div class="col-lg-10">
                          <input type="text" data-rule-number="true" name="norek" value="<?=$data_edit->norek;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Nomor Truk" class="control-label col-lg-2">Nomor Truk</label>
                        <div class="col-lg-10">
                          <input type="text" data-rule-number="true" name="no_truk" value="<?=$data_edit->no_truk;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Jenis Truk" class="control-label col-lg-2">Jenis Truk</label>
                        <div class="col-lg-10">
                          <input type="text" name="jns_truk" value="<?=$data_edit->jns_truk;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="No STNK" class="control-label col-lg-2">No STNK</label>
                        <div class="col-lg-10">
                          <input type="text" data-rule-number="true" name="stnk" value="<?=$data_edit->stnk;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="pjg_bak" value="<?=$data_edit->pjg_bak;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Tinggi Bak" class="control-label col-lg-2">Tinggi Bak</label>
                        <div class="col-lg-10">
                          <input type="text" name="tinggi_bak" value="<?=$data_edit->tinggi_bak;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Lebar Bak" class="control-label col-lg-2">Lebar Bak</label>
                        <div class="col-lg-10">
                          <input type="text" name="lbr_bak" value="<?=$data_edit->lbr_bak;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Volume" class="control-label col-lg-2">Volume</label>
                        <div class="col-lg-10">
                          <input type="text" name="volume" value="<?=$data_edit->volume;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Kapasitas Muatan" class="control-label col-lg-2">Kapasitas Muatan</label>
                        <div class="col-lg-10">
                          <input type="text" name="kapasitas" value="<?=$data_edit->kapasitas;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="No Tarif" class="control-label col-lg-2">No Tarif</label>
                        <div class="col-lg-10">
                          <input type="text" name="no_tarif" value="<?=$data_edit->no_tarif;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Tanggal Penawaran" class="control-label col-lg-2">Tanggal Penawaran</label>
                        <div class="col-lg-10">
                          <input type="text" id="tgl2" data-rule-date="true" name="tgl_penawaran" value="<?=$data_edit->tgl_penawaran;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Periode" class="control-label col-lg-2">Periode</label>
                        <div class="col-lg-10">
                          <input type="text" name="periode" value="<?=$data_edit->periode;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Tempo Bayar" class="control-label col-lg-2">Tempo Bayar</label>
                        <div class="col-lg-10">
                          <input type="text" name="tmp_bayar" value="<?=$data_edit->tmp_bayar;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Pelanggan" class="control-label col-lg-2">Pelanggan</label>
                        <div class="col-lg-10">
                          <input type="text" name="pelanggan" value="<?=$data_edit->pelanggan;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="tujuan" value="<?=$data_edit->tujuan;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Satuan" class="control-label col-lg-2">Satuan</label>
                        <div class="col-lg-10">
                          <input type="text" name="satuan" value="<?=$data_edit->satuan;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
                        <label for="Nilai" class="control-label col-lg-2">Nilai</label>
                        <div class="col-lg-10">
                          <input type="text" name="nilai" value="<?=$data_edit->nilai;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="satuan_penawaran" value="<?=$data_edit->satuan_penawaran;?>" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
