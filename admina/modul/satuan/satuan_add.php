...
<div class="row">
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/satuan/satuan_action.php?act=in">
                      <div class="form-group">
                        <label for="Nama Satuan" class="control-label col-lg-2">Nama Satuan</label>
                        <div class="col-lg-10">
                          <input type="text" name="nm_satuan" placeholder="Nama Satuan" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
<div class="form-group">
