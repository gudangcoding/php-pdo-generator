...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Edit Armada LTL Detail</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="box box-solid box-primary">
                <div class="box-header">
                    <h3 class="box-title">Edit Armada LTL Detail</h3>
                ...
                <div class="box-body">
                    <form id="update" method="post" class="form-horizontal"
                        action="<?=base_admin();?>modul/armada_ltl_detail/armada_ltl_detail_action.php?act=up">
                        <div class="row">
                  ...
                  echo "<option value='$isi->id'>$isi->nm_perusahaan</option>";
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div>
                                    <input type="text" name="no_pol" value="<?=$data_edit->no_pol;?>"
                            ...
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div>
                                    <input type="text" name="driver" value="<?=$data_edit->driver;?>"
                                        class="form-control" required>
                                </div>
                            </div><!-- /.form-group -->
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div>
                                    <input type="text" name="hp_driver1" value="<?=$data_edit->hp_driver1;?>"
                                        class="form-control" required>
                                </div>
                            </div><!-- /.form-group -->
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div>
                                    <input type="text" name="hp_driver2" value="<?=$data_edit->hp_driver2;?>"
                                        class="form-control">
                                </div>
                            </div><!-- /.form-group -->
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div>
                                    <input type="text" name="co_driver" value="<?=$data_edit->co_driver;?>"
                                        class="form-control" required>
                                </div>
                            </div><!-- /.form-group -->
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div>
                                    <input type="text" name="hp_co_driver1" value="<?=$data_edit->hp_co_driver1;?>"
                                        class="form-control" required>
                                </div>
                            </div><!-- /.form-group -->
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div>
                                    <input type="text" name="hp_co_driver2" value="<?=$data_edit->hp_co_driver2;?>"
                                        class="form-control">
                                </div>
                            </div><!-- /.form-group -->
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                ...
                                <div>
                                    <input type="text" name="remark" value="<?=$data_edit->remark;?>"
                                        class="form-control">
                                </div>
                            </div><!-- /.form-group -->
                        </div>
