...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?=base_index();?>dashboard-operasional">Dashboard Biaya Operasional</a></li>
        <li class="active">Dashboard Biaya Operasional</li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Dashboard Biaya Operasional</h3>
                </div><!-- /.box-header -->
                    ...
                    <div role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#ftldashboard" aria-controls="tab" role="tab" data-toggle="tab">
                                    Dashboard Biaya FTL <span class="badge btn-danger">1</span></a>

                            </li>
                            <li role="presentation">
                                <a href="#ltldashboard" aria-controls="tab" role="tab" data-toggle="tab">Dashboard Biaya LTL <span class="badge btn-danger">1</span></a>
                            </li>
                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="ftldashboard">
                                <h3 class="btn btn-primary btn-block">Dashboard Biaya FTL</h3>
                                <hr>
                                <?php 
