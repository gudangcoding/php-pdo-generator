...
<section class="content-header">
    <h1>
        Report Dan Tarik Data Operasional
    </h1>
        <ol class="breadcrumb">
        <li><a href="<?=base_index();?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?=base_index();?>report-dan-tarik-data">Report Dan Tarik Data Operasional</a></li>
        <li class="active">Report Dan Tarik Data Operasional</li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <h6 class="box-title">List Report Dan Tarik Data Operasional</h6>
                </div><!-- /.box-header -->
