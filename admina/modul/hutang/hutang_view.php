...
<section class="content-header">
    <h1>
        Dashboard Hutang Operasional
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?=base_index();?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="<?=base_index();?>dashboard-operasional">Dashboard Hutang Operasional</a></li>
        <li class="active">Dashboard Hutang Operasional</li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Dashboard Hutang Operasional</h3>
                </div><!-- /.box-header -->
                    ...
                    <div role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#ftldashboard" aria-controls="tab" role="tab" data-toggle="tab">Dashboard Hutang FTL <span class="badge btn-danger">1</span></a>
                            </li>
                            <li role="presentation">
                                <a href="#ltldashboard" aria-controls="tab" role="tab" data-toggle="tab">
                                    Dashboard Hutang LTL <span class="badge btn-danger">1</span></a>
                            </li>
