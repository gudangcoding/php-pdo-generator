          ...
          <div role="tabpanel">
            ...
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li role="presentation">
                <a href="#lokasi" aria-controls="tab" role="tab" data-toggle="tab">Informasi Lokasi</a>
              </li>
              <li role="presentation">
                <a href="#kargo" aria-controls="tab" role="tab" data-toggle="tab">Informasi Barang</a>
              </li>
             <!--  <li role="presentation">
  ...
  <a class="btn btn-primary" href='<?=base_index();?>daftar-muatan' role="button">List Muatan</a>
    ...
    <br>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-4">
                <input type="text" name="dn_no" value="<?=no_resi() ?>"  class="form-control" required>
            </div>
