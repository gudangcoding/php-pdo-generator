                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/jenis_truk/jenis_truk_action.php?act=in">
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" name="kode_jenis_truk" id="kode_jenis_truk" placeholder="Kode Jenis Truk" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
                      <div class="form-group">
                        <label for="Nama Jenis Truk" class="control-label col-lg-2">Nama Jenis Truk</label>
                        <div class="col-lg-10">
                          <input type="text" name="nama_jenis_truk" id="nama_jenis_truk" placeholder="Nama Jenis Truk" class="form-control" required> 
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="Kapasitas /ton">Kapasitas /ton</label>
                        <div class="col-lg-10">
                          <input type="number" name="kapasitaston" id="kapasitaston" placeholder="Kapasitas Muatan" class="form-control" required> 
                        </div>
                      </div><!-- /.form-group -->
                      <div class="form-group">
                        <label for="Kapasitas /kubik">Kapasitas /kubik</label>
                        <div class="col-lg-10">
                          <input type="number" name="kapasitaskubik" id="kapasitaskubik" placeholder="Kapasitas Muatan" class="form-control" required> 
                        </div>
                      </div>
