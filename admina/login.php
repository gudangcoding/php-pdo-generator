...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1251">
  ...
  <body>
    <div class="atas"><center>Selamat Datang</center></div>
			<div class="login">
				<!-- <form id="form" method="post"> -->
    <form method="POST" action="inc/login.php" accept-charset="UTF-8" id="form" novalidate="novalidate"><img id="gam" src="assets/login/img/login.png">
