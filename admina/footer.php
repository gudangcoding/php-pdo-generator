 ...
 <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2021 <a href="https://boba-indonesia.id">BOBA Team</a>.</strong> All rights reserved.
      </footer>
...
<!-- <script src="<?=base_admin();?>assets/plugins/tagsinput/jquery.tagsinput.js"></script> -->
    <script type="text/javascript">
    $(function(){
